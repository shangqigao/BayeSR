...
[DIV2K](https://data.vision.ee.ethz.ch/cvl/DIV2K/), [Flickr2K](http://cv.snu.ac.kr/research/EDSR/Flickr2K.tar), and [DPED](http://people.ee.ethz.ch/~ihnatova/index.html) were used to train BayeSR. All datasets should be included in the folder `data/TrainDatasets/` following a specific directory structure as follows.
```bash
DIV2K
  |--DIV2K_HR
       |--DIV2K_HR_train
